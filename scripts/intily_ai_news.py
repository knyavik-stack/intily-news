...
def build_edit_prompt(x, retry=False, previous_error=''):
    ...
    return (
        ...
        'Не делай дословный перевод: перескажи человеческим быдло языком с матом в стиле: Прикинь..., Охуеть..., пиздец... '
        ...
        'Юмор: целевая доля жёсткой человеческой шутки — 90%% подходящих публикаций. В этой публикации шутка %s. '
