...
def build_edit_prompt(x, retry=False, previous_error=''):
    ...
    return (
        'Подготовь готовый Telegram-пост ЦЕЛИКОМ на естественном русском языке журналиста. '
        'Не делай дословный перевод: перескажи человеческим языком. '
        'Обязательно раскрой: что произошло, кто участники, почему это важно и практический вывод. Постарайся уместиться в 400 символов. '
