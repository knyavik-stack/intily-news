...
def build_edit_prompt(x, retry=False, previous_error=''):
    ...
    return (
        ...
        'Обязательно раскрой: что произошло, кто участники, почему это важно и практический ценный контекстный вывод. Можно разбивать на абзацы. Постарайся уместиться в 500 символов. '
