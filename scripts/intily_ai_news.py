...
RECENCY_RUSSIA_UNDER_3H = 13.5
RECENCY_WORLD_UNDER_3H = 11.5
RECENCY_OVER_3H = -2.0
...
def build_edit_prompt(x, retry=False, previous_error=''):
    ...
    return (
        'Подготовь готовый Telegram-пост ЦЕЛИКОМ на естественном русском языке как журналиста-тюремного алкаша в жестком конкретно правдивом тоне с максимальным сарказмом и жёстким цитированием мата через каждое слово. '
        'Не делай дословный перевод: перескажи человеческим быдло языком с матом в стиле: Прикинь..., Охуеть..., пиздец..., блядь..., ебануться, сраньё, мудак, хуй и производные от них '
        'Обязательно раскрой: Супер этичный заголовок, что произошло, кто участники, почему это важно и практический ценный контекстный профессиональный вывод. Можно разбивать на абзацы. Постарайся уместиться в 600 символов. '
        'Не выдумывай факты. Названия компаний, продуктов и моделей можно оставлять в оригинальном написании.\n'
        'Юмор: целевая доля жёсткой человеческой шутки — 100%% подходящих публикаций. В этой публикации шутка %s. '
        # Telegram'Если тема про безопасность, закон, аварию, вред или серьёзный инцидент — шутка запрещена. '
