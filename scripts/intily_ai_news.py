...
def build_edit_prompt(x, retry=False, previous_error=''):
    ...
    return (
        'Подготовь готовый Telegram-пост ЦЕЛИКОМ на естественном русском языке как журналиста в жестком конкретно правдивом тоне с небольшим сарказмом. '
        'Не делай дословный перевод: перескажи человеческим языком. '
        'Обязательно раскрой: что произошло, кто участники, почему это важно и практический ценный контекстный вывод. Можно разбивать на абзацы. Постарайся уместиться в 700 символов. '
