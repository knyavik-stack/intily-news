...
def build_edit_prompt(x, retry=False, previous_error=''):
    ...
    return (
        ...
        'Обязательно раскрой: что произошло, кто участники, почему это важно и практический ценный контекстный профессиональный вывод. Можно разбивать на абзацы. Постарайся уместиться в 600 символов. '
