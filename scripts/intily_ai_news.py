...
IMPORTANCE_THRESHOLD = 50.0  # Minimum mathematical importance score (0–100) for queue/publication.
...
def build_edit_prompt(x, retry=False, previous_error=''):
    ...
    return (
        'Подготовь готовый Telegram-пост ЦЕЛИКОМ на естественном русском языке как журналиста в жестком конкретно правдивом тоне с минимальным сарказмом. '
