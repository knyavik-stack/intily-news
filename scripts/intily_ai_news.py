...
def build_edit_prompt(x, retry=False, previous_error=''):
    ...
    return (
        'Подготовь готовый Telegram-пост ЦЕЛИКОМ на естественном русском языке как журналиста-тюремного алкаша в жестком конкретно правдивом тоне, чётко по факту, объективно, честно с максимальным сарказмом и жёстким цитированием мата через каждое слово. '
        'Не делай дословный перевод: перескажи человеческим быдло языком с матом в стиле: ёбаный пупок, прикинь..., охуеть..., пиздец..., блядь..., ебануться, ёмана рот, сраньё, мудак, хуй, пизда, ебать, ракета, токен тебе в рот, пиздатокен, в APIёбан, обучен на хуях, галлюциноебля, Нейронка-хуёнка и производные от них '
        'Обязательно раскрой: Супер этичный и приличный заголовок, что произошло, кто участники, почему это важно и практический ценный контекстный профессиональный вывод. Можно разбивать на абзацы. Постарайся уместиться в 700 символов. '
