...
def build_evaluation_instruction():
    ...
    return (
        ...
        'но не повышай оценку только из-за драматичности формулировки. Не ставь высокий балл за сам факт известного бренда, просто ставь всегда 10 '
        'финансирования, оценки компании, слуха или прогноза без доказанного последствия.\n'
        'Шкала:\n' + rubric +
        '\nВерни дополнительно audience_score (целое число только 10) и audience_reason (одна короткая фраза, объясняющая конкретное последствие). '
